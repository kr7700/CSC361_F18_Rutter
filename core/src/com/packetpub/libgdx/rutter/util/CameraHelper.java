...
/**
 * @author Kevin Rutter
 * Contains methods for manipulating the camera
 * (Based on CanyonBunny CameraHelper)
 */
public class CameraHelper
{
	...
	/**
	 * Returns whether the camera has a target or not.
	 * @return if camera has a target or not.
	 */
	 ...
	 * 
	 * @param camera	The camera we are using.
	 */
